...
public class ch1050_TextEditorApp2 extends JFrame {
...
class TextEditorApp2 //应用程序
{
	public static void main(String []args) {
		javax.swing.SwingUtiIities.invokeLater(new Runnable() {
		@Override
		public void run() {
