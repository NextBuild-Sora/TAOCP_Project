...
public class ch731_TestList {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		
		//List<Photo> album = new ArrayList<>(); 	可以这样写。
		List<Photo> album = new LinkedList<>();
		
		album.add(new Photo("一", new Date(), "课堂"));
		album.add(new Photo("二", new Date(),"图书"));
		album.add(new Photo("三", new Date(), "体育"));
		album.add(new Photo("three", new Date(), "宿舍"));
