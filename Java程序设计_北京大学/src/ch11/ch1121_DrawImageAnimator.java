...
public class ch1121_DrawImageAnimator extends JPanel 
{

	public ch1121_DrawImageAnimator() {
		...
		try {
			...
			for( int i=0; i<num; i++ ) {
				if ( files[i].toLowerCase().endsWith(".pang")
	...
	public static void main(String[] args) {
		...
		SwingUtilities.invokeLater( ()->{
			JFrame f = new JFrame("Draw Image( 绘画图片 )");
			f.setSize( 400, 300 );
			f.add(new ch1121_DrawImageAnimator() );
