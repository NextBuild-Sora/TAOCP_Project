...
public class ch1124_JMFMediaPlayer extends JFrame implements ActionListener, ControllerListener, ItemListener 
{
	...
	// 构造方法
	public ch1124_JMFMediaPlayer(String title) {
		...
		JMenuItem openMemuUtem = new JMenuItem("打开");
    ...
    */
	...
	public static void main(String[] args) 
	{
		...
		new ch1124_JMFMediaPlayer("JMF媒体播放器");
	}
